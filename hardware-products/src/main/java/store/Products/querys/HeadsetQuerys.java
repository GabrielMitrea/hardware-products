...
public class HeadsetQuerys {
    ...
    public final static String GET_HEADSET1_SQL="select p.productName, c.categoryName, h.headsetType, h.technology, h.sound, h.conectivity, p.productPrice\n" +
    ...
    public final static String ADD_HEADSET_SQL="insert into headset(headsetId,categoryId,headsetType,technology,sound,conectivity,productId) values (null,?,?,?,?,?,?)";
