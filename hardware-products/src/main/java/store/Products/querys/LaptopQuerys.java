...
//            "ON l.categoryId=c.categoryId";
    ...
    public final static String GET_LAPTOP1_SQL="select p.productName, l.laptopType, l.cpuModel, l.gpuModel, l.memoryRamSize,l.storageCapacity, p.productPrice\n" +
            "from proiect_java.laptop l inner join proiect_java.product p\n" +
            "on l.productId=p.productId";

    public final static String ADD_LAPTOP_SQL="insert into laptop(laptopId,laptopType,cpuModel,gpuModel,memoryRamSize, storageCapacity, productId) values (null,?,?,?,?,?,?)";
