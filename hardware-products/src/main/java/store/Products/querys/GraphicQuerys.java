...
public class GraphicQuerys {
    ...
    public final static String GET_GRAPHICCARD1_SQL="select  c.categoryName,p.productName, gc.memorySize, gc.memoryType, gc.interfacee, p.productPrice\n" +
            ...
            "on gc.categoryId=c.categoryId";
    public final static String ADD_GRAPHICCARD_SQL="insert into graphiccard(graphicCardId,categoryId,memorySize,memoryType,interfacee,productId) values (null,?,?,?,?,?)";
